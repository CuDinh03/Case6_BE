...
//    }
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().antMatchers("/statuses/search/**/**","/comments", "/comments/**", "/images", "/images/**", "/likes/**", "/like-statuses/**", "/relationships/**", "/statuses/**", "/main").access("hasRole('ROLE_USER')")
